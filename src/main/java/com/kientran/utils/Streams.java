...
public class Streams {
	...
	/**
	 * Wrapper around {@link #asStream(Iterable, boolean)} that sets 'parallel'
	 * to false.
	 */
	...
	/**
	 * Return a {@link Stream} for the supplied {@link Iterable}, since
	 * iterables by themselves can only give a {@link Spliterator}.
	 * 
	 * @param iterable
