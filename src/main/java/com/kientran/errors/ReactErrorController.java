...
/**
 * Largely pinched from
 * {@link org.springframework.boot.autoconfigure.web.BasicErrorController} and
 * customised to render our React template, along with an appropriate populated
 * state.
 */
...
public class ReactErrorController extends AbstractErrorController {
	...
	/**
	 * Render the standard template, but include all the error information we
	 * know about. In a production application, you may not want to pass all
