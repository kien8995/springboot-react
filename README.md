...
2. **Clone this repository.** - `git clone https://github.com/kien8995/springboot-react.git` or [download the zip](https://github.com/kien8995/springboot-react/archive/master.zip)
